    ...
    return (
        ...
        <form className="left">
            ...
            <ul>
                {options.map((option, index) => (
                    <>
                        <li><i className="material-icons">radio_button_unchecked</i> 
                        <input
                            id={index}
                            type="checked"
        ...
        <br/>
            ...
            <ul id="chooseOptions">
                {options.map((option, index) => (
                     <li>
                        <input type="radio" id={"option-" +index + 1} name="checkboxOptions" />
                        <label for={"mc-option-" + index + 1}>{option.content}</label>
                     </li>
                ))}
            </ul>
        </div>
